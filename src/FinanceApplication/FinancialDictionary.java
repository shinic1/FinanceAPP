...
public class FinancialDictionary {
    // A map to store financial terms and their definitions
    private Map<String, String> terms;

    /*
     * Constructor to initialize the FinancialDictionary with predefined terms and
     * definitions.
     */
    public FinancialDictionary() {
        terms = new HashMap<>(); // Creates a new HashMap to hold the terms
        // Adds financial terms and their corresponding definitions to the map
        ...
        terms.put("Investment",
                "The act of allocating money or resources to an asset with the expectation of generating a return over time.");
        ...
        terms.put("MutualFund",
                "An investment vehicle pooling money from many investors to buy a diversified portfolio of securities.");
        terms.put("ETF", "A collection of securities traded on a stock exchange, similar to stocks.");
        ...
        terms.put("Collateral",
                " An asset pledged as security for a loan, which the lender can seize if the loan is not repaid.");
        ...
        terms.put("TaxCredit",
                "A direct reduction in the amount of tax owed, often for specific activities or demographics.");
        ...
        terms.put("RothIRA",
                "A retirement account allowing tax-free withdrawals after retirement but funded with after-tax dollars.");
        ...
        terms.put("Recession",
                "A period of economic decline, typically defined by a fall in GDP for two consecutive quarters.");
        ...
        terms.put("Deductible",
                "The amount an insured person must pay out of pocket before insurance coverage begins.");
        ...
        terms.put("Yield",
                "The income generated by an investment, expressed as a percentage of the investment's cost.");
    ...
    public String getDefinition(String term) {
        return terms.getOrDefault(term, "Term not found"); // Returns the definition or a default message
    }
}
